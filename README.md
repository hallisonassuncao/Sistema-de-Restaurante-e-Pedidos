...
Sistema-De-Restaurante/ ├── node_modules/ ├── images/ ├── public/ │   └── [arquivos públicos, ex: favicon, index.html base] ├── src/ │   ├── assets/ │   ├── components/ │   ├── daos/ │   ├── objetos/ │   ├── pages/ │   ├── routes/ │   ├── App.css │   ├── App.jsx │   ├── index.css │   └── main.jsx ├── .gitignore ├── eslint.config.js ├── index.html ├── package-lock.json ├── package.json ├── README.md ├── vite.config.js └── vite.config.vercel.js
