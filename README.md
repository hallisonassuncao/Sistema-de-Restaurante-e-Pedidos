...
🔄 Fluxo de Uso
- Cadastro de Cliente → Inserir dados básicos.
- Cadastro de Prato → Adicionar opções ao cardápio.
- Registro de Pedido → Selecionar cliente e prato, confirmar pedido.
- Relatórios → Consultar estatísticas de pedidos e clientes.
